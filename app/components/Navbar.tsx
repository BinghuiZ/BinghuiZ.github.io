...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'skills', 'experience', 'projects', 'articles', 'contact']
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-gray-900 shadow-md z-10">
      <div className="flex justify-between items-center p-4 max-w-6xl mx-auto">
        <ul className="flex space-x-6">
          {['Home', 'Skills', 'Experience', 'Projects', 'Articles', 'Contact'].map((item) => (
            <li key={item}>
              <button
